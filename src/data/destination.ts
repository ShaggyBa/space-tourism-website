export const destinationData: Destination[] = [
	{
		name: "Moon",
		image: "/public/assets/destination/image-moon.webp",
	...
	{
		name: "Mars",
		image: "/public/assets/destination/image-mars.webp",
		description: `Don’t forget to pack your hiking boots. 
		You’ll need them to tackle Olympus Mons, the tallest planetary mountain
	...
	{
		name: "Europa",
		image: "/public/assets/destination/image-europa.webp",
		...
		for a bit of ice skating, curling, hockey, or simple relaxation in your 
		snug wintery cabin.`,
		distance: "628 MIL. km",
		travel: "3 years",
	},
	{
		name: "Titan",
		image: "/public/assets/destination/image-titan.webp",
